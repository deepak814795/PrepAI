                ...
                <div className="pb-12 bg-white">
                    <div className="relative">
                        ...
                        <div className="relative mx-auto">
                           <div className="lg:max-w-6xl lg:mx-auto mt-24">
                                <div className="lg:col-span-3 relative p-6 rounded-2xl">
                                    <div className="absolute inset-0 bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] blur-xl opacity-50"></div>
